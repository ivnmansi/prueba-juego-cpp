...
void TextureManager::drawTexture(const std::string& id, SDL_Renderer* renderer, const Vector2D& position, const Vector2D& size, SDL_Rect* rect) {
...
bool TextureManager::loadTexturesFromDirectory(std::string directory, SDL_Renderer* renderer){
